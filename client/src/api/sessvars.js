...
[2000 {default}]How many Kb of data you can store in sessvars. Defaults to 2000 Kb, because Opera 9.25 seems to have a limit just above that. IE7.0, Firefox 1.5/2.0 and Safari 3.0 all have higher limits – 10 MB is no problem in those browsers. 

sessvars.$.prefs.autoFlush
[true {default} /false]Determines whether sessvars should flush/save automatically (see methods). 

sessvars.$.prefs.crossDomain
[true/false {default}]If this flag is set to true the content of sessvars can be read across different domains (if both sites use sessvars.js). 

sessvars.$.prefs.includeFunctions
[true/false {default}]Determines whether sessvars remembers functions assigned to it across page loads. 

sessvars.$.prefs.includeProtos
[true/false {default}]If this flag is set to true sessvars remembers properties assigned to the prototype of different data/object types across page loads. Rarely needed. 
-->
*/
