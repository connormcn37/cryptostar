...
StackdriverErrorReporter.prototype.start = function(config) {
  ...
  if (typeof StackTrace === "undefined") {
    ...
    throw new Error(
      "make sure you loaded “dist/stackdriver-errors-concat.js” or “dist/stackdriver-errors-concat.min.js”, or that you imported the “stacktrace-js” module"
    );
  }
...
StackdriverErrorReporter.prototype.sendErrorPayload = function(
  payload,
  callback
) {
  var defaultUrl =
